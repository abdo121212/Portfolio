...
const Navbar = () => {
  ...
  return (
    <>
      <div className="flex justify-between items-center w-full h-20 px-4 text-white bg-black fiexd z-50 py-11">
        <div>
          <h1 className="font-signature text-5xl ml-2 cursor-pointer">Abdallah</h1>
        </div>
    ...
    {nav &&   <ul className="flex flex-col justify-center items-center absolute top-0 left-0 h-screen w-full bg-gradient-to-b from-black to-gray-700 ">
          {links.map(({ id, link }) => (
            <li
              key={id}
